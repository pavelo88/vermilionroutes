...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = 'primary', size = 'md', children, ...props }, ref) => {
    ...
    const variants = {
      primary:
        'bg-[#926E1D] hover:bg-[#805F18] text-white dark:bg-[#D1A852] dark:hover:bg-[#C49B45] dark:text-zinc-950 font-bold shadow-sm shadow-amber-900/20 hover:shadow-md hover:shadow-amber-900/30 border border-amber-600/30 dark:border-amber-400/30',
      outline:
