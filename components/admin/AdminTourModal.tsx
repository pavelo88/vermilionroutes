        ...
        <form onSubmit={handleSubmit} className="space-y-5 text-xs">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="space-y-1">
              ...
              <input
                ...
                className="w-full p-2.5 bg-zinc-950 border border-zinc-800 rounded-xl text-white font-mono focus:border-emerald-500 focus:outline-none"
              />
            </div>
          ...
          <div className="space-y-1">
            ...
            <input
              ...
              className="w-full p-2.5 bg-zinc-950 border border-zinc-800 rounded-xl text-white text-sm font-semibold focus:border-emerald-500 focus:outline-none"
            />
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div className="space-y-1">
              ...
              <input
                ...
                className="w-full p-2.5 bg-zinc-950 border border-zinc-800 rounded-xl text-white font-bold focus:border-emerald-500 focus:outline-none"
              />
            </div>
          ...
          <div className="space-y-2 bg-zinc-950/70 p-4 rounded-2xl border border-zinc-800">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-12 gap-3 items-center">
              ...
              <div
                ...
                className={`sm:col-span-7 border-2 border-dashed rounded-xl p-3 text-center transition-colors relative cursor-pointer ${
                  isDraggingMain
              ...
              <div className="sm:col-span-5">
                <input
                  ...
                  className="w-full p-2.5 bg-zinc-900 border border-zinc-800 rounded-xl text-white font-mono text-[11px] focus:border-emerald-500 focus:outline-none"
                />
              </div>
            </div>
            ...
            {formData.gallery && formData.gallery.length > 0 && (
              <div className="grid grid-cols-4 sm:grid-cols-6 gap-2 pt-2">
                {formData.gallery.map((imgUrl, idx) => (
                  <div key={idx} className="relative group rounded-lg overflow-hidden border border-zinc-700 aspect-video">
                    <img src={imgUrl} alt={`Gallery ${idx + 1}`} className="w-full h-full object-cover" />
                    <button
                      type="button"
                      onClick={() => handleRemoveGalleryImage(idx)}
                      className="absolute top-1 right-1 p-1 bg-black/80 hover:bg-rose-900 text-white rounded-full opacity-0 group-hover:opacity-100 transition-opacity"
                      title="Remove image"
                    >
          ...
          <div className="flex justify-end gap-3 pt-4 border-t border-zinc-800">
            <Button
              ...
              variant="outline"
              onClick={onClose}
              className="bg-zinc-800 text-zinc-300 border-zinc-700 cursor-pointer"
            >
              Cancel
            </Button>
            <Button
