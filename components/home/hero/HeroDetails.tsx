      ...
      {[0, 1].map((isOdd) => {
        ...
        return (
          <div
            key={id}
            id={id}
            className="absolute left-0 w-full px-4 md:px-0 md:w-auto md:left-[30px] lg:left-[60px] top-[135px] sm:top-[125px] md:top-[90px] lg:top-[95px] pt-4 sm:pt-6 md:pt-0 z-[22] flex flex-col items-center md:items-start text-center md:text-left"
          >
