...
const multiDayTours: Tour[] = [
  ...
  // Tour 5: Volcanoes & Rivers (8 Days)
  {
    ...
    title: { 
      en: 'AVENUE OF THE VOLCANOES, WATERFALLS & AMAZON (8 DAYS)', 
      es: 'AVENIDA DE LOS VOLCANES, CASCADAS Y SELVA AMAZÓNICA (8 DÍAS)', 
      fr: 'AVENUE DES VOLCANS, CASCADES ET AMAZONIE (8 JOURS)', 
      de: 'STRASSE DER VULKANE, WASSERFÄLLE & AMAZONAS (8 TAGE)', 
      it: 'VIALE DEI VULCANI, CASCATE E AMAZZONIA (8 GIORNI)', 
      pt: 'AVENIDA DOS VULCÕES, CACHOEIRAS E AMAZÔNIA (8 DIAS)', 
      ja: '火山の道・滝・アマゾン熱帯雨林 8日間の旅', 
      zh: '火山大道、壮丽瀑布与亚马逊丛林8日深度游' 
    },
  ...
  // Tour 6: Andes & Amazon Rainforest (7 Days)
  {
    ...
    title: { 
      en: 'ANDES, VOLCANOES & AMAZON RAINFOREST (7 DAYS)', 
      es: 'ANDES, VOLCANES Y SELVA AMAZÓNICA (7 DÍAS)', 
      fr: 'ANDES, VOLCANS ET FORÊT AMAZONIENNE (7 JOURS)', 
      de: 'ANDEN, VULKANE & AMAZONAS-REGENWALD (7 TAGE)', 
      it: 'ANDE, VULCANI E FORESTA AMAZZONICA (7 GIORNI)', 
      pt: 'ANDES, VULCÕES E FLORESTA AMAZÔNICA (7 DIAS)', 
      ja: 'アンデス、火山、アマゾン熱帯雨林 7日間の旅', 
      zh: '安第斯山脉、火山与亚马逊雨林7日全景游' 
    },
    destination: 'Mainland Ecuador',
    duration: { 
      en: '7 DAYS / 6 NIGHTS', 
  ...
  // Tour 7: Snow-Capped Volcanoes & Waterfalls (6 Days)
  {
    ...
    title: { 
      en: 'SNOW-CAPPED VOLCANOES & ANDEAN LAKES (6 DAYS)', 
      es: 'VOLCANES NEVADOS Y LAGUNAS ANDINAS (6 DÍAS)', 
      fr: 'VOLCANS ENNEIGÉS ET LACS ANDINS (6 JOURS)', 
      de: 'SCHNEEGEKRÖNTE VULKANE & ANDENSEEN (6 TAGE)', 
      it: 'VULCANI INNEVATI E LAGHI ANDINI (6 GIORNI)', 
      pt: 'VULCÕES NEVADOS E LAGOAS ANDINAS (6 DIAS)', 
      ja: '雪冠火山とアンデス湖沼群 6日間の旅', 
      zh: '雪峰火山与安第斯高山湖泊6日探索之旅' 
    },
    destination: 'Mainland Ecuador',
    duration: { 
      en: '6 DAYS / 5 NIGHTS', 
  ...
  // Tour 8: Ecuador Fantastic (8 Days)
  {
    ...
    title: { 
      en: 'ECUADOR FANTASTIC: ANDES, AMAZON & COAST (8 DAYS)', 
      es: 'ECUADOR FANTÁSTICO: ANDES, AMAZONÍA Y COSTA (8 DÍAS)', 
      fr: 'ÉQUATEUR FANTASTIQUE: ANDES, AMAZONIE ET CÔTE (8 JOURS)', 
      de: 'FASZINATION ECUADOR: ANDEN, AMAZONAS & KÜSTE (8 TAGE)', 
      it: 'ECUADOR FANTASTICO: ANDE, AMAZZONIA E COSTA (8 GIORNI)', 
      pt: 'EQUADOR FANTÁSTICO: ANDES, AMAZÔNIA E COSTA (8 DIAS)', 
      ja: 'エクアドル・ファンタスティック：アンデス・アマゾン・海岸 8日間の旅', 
      zh: '梦幻厄瓜多尔：安第斯高原、亚马逊丛林与太平洋海岸8日全景游' 
    },
    destination: 'Mainland Ecuador',
    duration: { 
      en: '8 DAYS / 7 NIGHTS', 
