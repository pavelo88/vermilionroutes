...
export const mockTours: Tour[] = [
  ...
  },
  {
    ...
    itinerary: [
      { day: 1, title: 'Arrival in Quito', description: 'Private transfer to hotel and orientation.' },
      { day: 2, title: 'Colonial Quito & Cable Car', description: 'Old town tour and cable car ride up to 4,000m.' },
      { day: 3, title: 'Cotopaxi Volcano & Hacienda Stay', description: 'Hike near Limpiopungo lagoon and overnight in historic hacienda.' },
      { day: 4, title: 'Quilotoa Emerald Crater Loop', description: 'Viewpoint hike around the volcanic crater lake.' },
      { day: 5, title: 'Baños & Devil’s Cauldron Waterfall', description: 'Waterfall highway hike and edge-of-the-world swing.' },
    ],
  },
  {
    id: 'peru-essential',
    ...
    itinerary: [
      { day: 1, title: 'Arrival in Cusco', description: 'Airport welcome and rest for acclimatization.' },
      { day: 2, title: 'Sacred Valley Highlights', description: 'Explore Pisac market and Ollantaytambo ruins.' },
      { day: 3, title: 'Machu Picchu Citadel', description: 'Private guided tour and postcard photos.' },
    ],
  },
  {
    ...
    itinerary: [
      { day: 1, title: 'Arrival in Lima', description: 'Private welcome and coastal hotel check-in.' },
      { day: 2, title: 'Paracas & Ballestas Islands', description: 'Marine boat tour to spot penguins and sea lions.' },
      { day: 3, title: 'Ica & Nazca Lines Flight', description: 'Flight over ancient desert geoglyphs.' },
    ],
  },
  {
    ...
    itinerary: [
      { day: 1, title: 'Arrival in San Cristobal', description: 'Airport welcome & hotel check-in. Evening at La Loberia beach with sea lion pups.', meals: 'Welcome Lunch', accommodation: 'San Cristobal Hotel 3★' },
      { day: 2, title: 'Kicker Rock Snorkel', description: 'Full day yacht excursion to León Dormido snorkeling with sharks & rays.', meals: 'Breakfast & Onboard Lunch', accommodation: 'San Cristobal Hotel 3★' },
      { day: 3, title: 'Santa Cruz Transfer & Highlands', description: 'Speedboat to Santa Cruz. Giant tortoise reserve in the misty highlands.', meals: 'Breakfast & Lunch', accommodation: 'Puerto Ayora Hotel 3★' },
      { day: 4, title: 'Tortuga Bay & Las Ninfas', description: 'Morning hike to Tortuga Bay. Afternoon at mangrove-lined Las Ninfas lagoon.', meals: 'Breakfast', accommodation: 'Puerto Ayora Hotel 3★' },
      { day: 5, title: 'Black Turtle Cove Kayaking', description: 'Kayak tour through quiet mangroves spotting sea turtles and reef sharks.', meals: 'Breakfast & Lunch', accommodation: 'Puerto Ayora Hotel 3★' },
      { day: 6, title: 'Santa Cruz Fish Market & Pelicans', description: 'Morning visit to the fish market where pelicans & sea lions compete for scraps.', meals: 'Breakfast', accommodation: 'Puerto Ayora Hotel 3★' },
      { day: 7, title: 'Baltra Airport & Departure', description: 'Transfer to Baltra airport for return flight.', meals: 'Breakfast' },
    ],
  },
  {
    ...
    itinerary: [
      { day: 1, title: 'Arrival & Welcome Dinner', description: 'Private transfer to your boutique hotel. Welcome orientation dinner by your guide.', meals: 'Gourmet Welcome Dinner', accommodation: 'Royal Palm Galapagos 5★' },
      { day: 2, title: 'Charles Darwin Station & Giant Tortoises', description: 'Visit the famous research station then highlands tortoise reserve.', meals: 'Breakfast, Lunch & Dinner', accommodation: 'Royal Palm Galapagos 5★' },
      { day: 3, title: 'Yacht to Santa Fe & Las Grietas', description: 'Full day yacht excursion: snorkel Santa Fe Island, swim at volcanic Las Grietas crevice.', meals: 'Breakfast, Onboard Lunch & Dinner', accommodation: 'Royal Palm Galapagos 5★' },
      { day: 4, title: 'Tortuga Bay & Ocean Kayaking', description: 'Hike through cactus forest to pristine Tortuga Bay. Afternoon sea kayaking.', meals: 'Breakfast, Lunch & Dinner', accommodation: 'Royal Palm Galapagos 5★' },
      { day: 5, title: 'Scuba or Snorkel at Seymour Norte', description: 'Private boat to North Seymour to watch nesting frigatebirds and blue-footed boobies.', meals: 'Breakfast, Packed Lunch & Farewell Dinner', accommodation: 'Royal Palm Galapagos 5★' },
      { day: 6, title: 'Baltra Airport Departure', description: 'Transfer to Baltra airport for your outbound flight.', meals: 'Breakfast' },
    ],
  },
  {
    ...
    itinerary: [
      { day: 1, title: 'Arrival Santa Cruz & Darwin Station', description: 'Arrival in Baltra, transfer to hotel in Puerto Ayora and guided tour of Charles Darwin Station.', meals: 'Lunch & Dinner', accommodation: 'Finch Bay Eco Hotel 4★' },
      { day: 2, title: 'Giant Tortoise Reserve & Highlands', description: 'Morning highlands tour observing giant tortoises in the wild.', meals: 'Breakfast, Lunch & Dinner', accommodation: 'Finch Bay Eco Hotel 4★' },
      { day: 3, title: 'Yacht to Santa Fe Snorkeling', description: 'Full-day private yacht excursion to snorkel the pristine waters of Santa Fe Island.', meals: 'Breakfast, Onboard Lunch & Dinner', accommodation: 'Finch Bay Eco Hotel 4★' },
      { day: 4, title: 'Las Grietas & Tortuga Bay', description: 'Swim in Las Grietas volcanic crevice, hike to stunning Tortuga Bay.', meals: 'Breakfast, Lunch & Dinner', accommodation: 'Finch Bay Eco Hotel 4★' },
      { day: 5, title: 'Isabela Island Transfer & Tintoreras', description: 'Speedboat to Isabela. Evening tour around Tintoreras islet spotting Galapagos penguins.', meals: 'Breakfast, Lunch & Dinner', accommodation: 'Albemarle Isabela Hotel 4★' },
      { day: 6, title: 'Sierra Negra Volcano Hike', description: 'Trek the rim of the world\'s second-largest volcanic caldera with sweeping ocean views.', meals: 'Breakfast, Trail Lunch & Dinner', accommodation: 'Albemarle Isabela Hotel 4★' },
      { day: 7, title: 'Isabela Marine Reserve Snorkel', description: 'Dive into Isabela\'s pristine marine reserve, spot hammerhead sharks & manta rays.', meals: 'Breakfast, Onboard Lunch & Dinner', accommodation: 'Albemarle Isabela Hotel 4★' },
      { day: 8, title: 'Flamingo & Seahorse Lagoons', description: 'Visit the flamingo breeding lagoons and swimming seahorse alcove.', meals: 'Breakfast, Lunch & Farewell Dinner', accommodation: 'Albemarle Isabela Hotel 4★' },
      { day: 9, title: 'Transfer to Baltra & Departure', description: 'Boat to Santa Cruz, bus to Baltra airport for outbound flight.', meals: 'Breakfast' },
    ],
  },
  {
    ...
    itinerary: [
      { day: 1, title: 'Arrival San Cristobal & La Loberia', description: 'Airport arrival, hotel check-in, La Loberia sunset beach walk with sea lions.', meals: 'Lunch', accommodation: 'Casa Blanca San Cristobal 3★' },
      { day: 2, title: 'Kicker Rock Snorkel Expedition', description: 'Full-day boat tour to León Dormido: Galapagos sharks, eagle rays, sea turtles.', meals: 'Breakfast & Onboard Lunch', accommodation: 'Casa Blanca San Cristobal 3★' },
      { day: 3, title: 'Santa Cruz Transfer & Highlands', description: 'Speedboat to Santa Cruz, afternoon giant tortoise reserve tour.', meals: 'Breakfast & Lunch', accommodation: 'Solymar Oceanfront 3★' },
      { day: 4, title: 'Tortuga Bay Kayaking & Las Ninfas', description: 'Hike to Tortuga Bay and kayak through mangrove-lined Las Ninfas.', meals: 'Breakfast & Lunch', accommodation: 'Solymar Oceanfront 3★' },
      { day: 5, title: 'Santa Fe Island Snorkel Cruise', description: 'Boat excursion to Santa Fe to snorkel with sea lions and colorful fish.', meals: 'Breakfast & Onboard Lunch', accommodation: 'Solymar Oceanfront 3★' },
      { day: 6, title: 'Isabela Transfer & Tintoreras', description: 'Speedboat to Isabela, afternoon Tintoreras penguin and iguana tour.', meals: 'Breakfast & Lunch', accommodation: 'Albemarle Hotel Isabela 3★' },
      { day: 7, title: 'Sierra Negra Volcano Hike', description: 'Trek the spectacular crater rim of Sierra Negra active volcano.', meals: 'Breakfast & Trail Lunch', accommodation: 'Albemarle Hotel Isabela 3★' },
      { day: 8, title: 'Flamingo Lagoons & Snorkel Concha de Perla', description: 'Morning flamingo lagoon, afternoon snorkel the famous Concha de Perla marine reserve.', meals: 'Breakfast & Lunch', accommodation: 'Albemarle Hotel Isabela 3★' },
      { day: 9, title: 'Return to Baltra & Departure', description: 'Transfer via speedboat and bus to Baltra airport.', meals: 'Breakfast' },
    ],
  },
  {
    ...
    gallery: ['https://images.unsplash.com/photo-1589802829985-817e51171b92?auto=format&fit=crop&w=1200&q=80'],
    highlights: [
    ...
    exclusions: ['International flights', 'Gratuities', 'Personal expenses'],
    itinerary: [
      { day: 1, title: 'Arrival Quito', description: 'Private airport pickup and hotel check-in.', meals: 'None', accommodation: 'Hotel Boutique Quito 4★' },
      { day: 2, title: 'Colonial Quito & Equatorial Line', description: 'Walk the UNESCO Old Town, visit Mitad del Mundo monument.', meals: 'Breakfast', accommodation: 'Hotel Boutique Quito 4★' },
      { day: 3, title: 'Cotopaxi Volcano Highlands', description: 'Drive to Cotopaxi National Park. Hike near Limpiopungo lagoon and approach the glacier.', meals: 'Breakfast & Picnic Lunch', accommodation: 'Hotel Boutique Quito 4★' },
      { day: 4, title: 'Transfer to Tena Amazon Lodge', description: 'Descend the Andes into the Amazon. Afternoon arrival at eco-lodge.', meals: 'Breakfast & Dinner', accommodation: 'Tena Eco-Lodge 3★' },
      { day: 5, title: 'Jungle Safari: Canoe & Wildlife', description: 'Motorized canoe safari, wildlife spotting, and Quichua community visit.', meals: 'Breakfast, Lunch & Dinner', accommodation: 'Tena Eco-Lodge 3★' },
      { day: 6, title: 'Canopy & Return to Quito', description: 'Morning zip-line canopy experience, afternoon transfer back to Quito.', meals: 'Breakfast', accommodation: 'Hotel Boutique Quito 4★' },
      { day: 7, title: 'Departure Transfer', description: 'Private transfer to Quito airport.', meals: 'Breakfast' },
    ],
  },
  {
    ...
    gallery: ['https://images.unsplash.com/photo-1518709268805-4e9042af9f23?auto=format&fit=crop&w=1200&q=80'],
    highlights: [
    ...
    exclusions: ['International flights', 'Dinners not listed', 'Gratuities'],
    itinerary: [
      { day: 1, title: 'Arrival Quito & Old Town', description: 'Airport pickup, colonial Quito orientation walk.', meals: 'None', accommodation: 'Hotel Quito 3★' },
      { day: 2, title: 'Quilotoa Crater Lake Hike', description: 'Hike around the stunning turquoise volcanic crater lake.', meals: 'Breakfast & Lunch', accommodation: 'Quilotoa Lodge' },
      { day: 3, title: 'Riobamba & Chimborazo Glacier', description: 'Drive through the Avenue of Volcanoes. Visit Chimborazo, the world\'s closest point to the sun.', meals: 'Breakfast & Lunch', accommodation: 'Hotel Riobamba 3★' },
      { day: 4, title: 'Baños & Pailon del Diablo', description: 'Visit the thermal waterfall town of Baños and the powerful Pailon del Diablo cascade.', meals: 'Breakfast', accommodation: 'Hotel Sangay Baños 3★' },
      { day: 5, title: 'Ruta de las Cascadas & Edge Swing', description: 'Bike the waterfall route, ride the famous edge-of-the-world swing.', meals: 'Breakfast & Lunch', accommodation: 'Hotel Sangay Baños 3★' },
      { day: 6, title: 'Return Quito & Departure', description: 'Transfer to Quito airport.', meals: 'Breakfast' },
    ],
  },
  {
    ...
    itinerary: [
      { day: 1, title: 'Quito Arrival', description: 'Welcome meeting and gear briefing.', meals: 'None', accommodation: 'Hotel Boutique Quito 3★' },
      { day: 2, title: 'Colonial Quito City Tour', description: 'Full guided day of Quito\'s UNESCO historic centre.', meals: 'Breakfast', accommodation: 'Hotel Boutique Quito 3★' },
      { day: 3, title: 'Cotopaxi Hike & Limpiopungo', description: 'Hike near the Cotopaxi Lagoon with snowcapped views.', meals: 'Breakfast & Picnic Lunch', accommodation: 'Hacienda Cotopaxi' },
      { day: 4, title: 'Horseback Riding Páramo', description: 'Equestrian tour through the volcanic páramo ecosystem.', meals: 'Breakfast & Lunch', accommodation: 'Hacienda Cotopaxi' },
      { day: 5, title: 'Quilotoa Crater Lake', description: 'Hike down into the crater and kayak on the emerald lagoon.', meals: 'Breakfast & Lunch', accommodation: 'Quilotoa Lodge' },
      { day: 6, title: 'Toachi River Whitewater Rafting', description: 'Class III-IV full-day rafting on the Toachi River through lush canyon.', meals: 'Breakfast & Riverside Lunch', accommodation: 'Hotel Baños 3★' },
      { day: 7, title: 'Blanco River Rafting & Pailon del Diablo', description: 'Morning rafting on Class III Blanco River, afternoon at Devil\'s Cauldron falls.', meals: 'Breakfast & Lunch', accommodation: 'Hotel Baños 3★' },
      { day: 8, title: 'Return Quito & Departure', description: 'Transfer to Quito airport.', meals: 'Breakfast' },
    ],
  },
  {
    id: 'andean-world',
    ...
    itinerary: [
      { day: 1, title: 'Quito Arrival', description: 'Airport pickup, hotel check-in.', meals: 'None', accommodation: 'Boutique Hotel Quito 4★' },
      { day: 2, title: 'Colonial Quito & Cable Car', description: 'Old Town tour + cable car ride up to 4,100m for volcano panoramas.', meals: 'Breakfast', accommodation: 'Boutique Hotel Quito 4★' },
      { day: 3, title: 'Mindo Cloud Forest', description: 'Birdwatching, butterfly garden, and canopy zip-line in the cloud forest.', meals: 'Breakfast & Lunch', accommodation: 'Mindo Garden Lodge 3★' },
      { day: 4, title: 'Otavalo Saturday Market', description: 'Shop the famous indigenous craft market and visit local artisan workshops.', meals: 'Breakfast & Lunch', accommodation: 'Hacienda Cusin 4★' },
      { day: 5, title: 'Cuicocha Volcanic Lake', description: 'Boat tour on the stunning twin-island crater lake of Cuicocha.', meals: 'Breakfast & Lunch', accommodation: 'Hacienda Cusin 4★' },
      { day: 6, title: 'Quilotoa Crater Trek', description: 'Hike the magnificent Quilotoa loop crater.', meals: 'Breakfast & Lunch', accommodation: 'Quilotoa Lodge' },
      { day: 7, title: 'Riobamba & Chimborazo', description: 'Visit the ice harvester community at Chimborazo volcano (6,263m).', meals: 'Breakfast & Lunch', accommodation: 'Hotel Riobamba 4★' },
      { day: 8, title: 'Cuenca Colonial City', description: 'Walking tour of UNESCO Cuenca: cathedral, panama hat workshops.', meals: 'Breakfast & Lunch', accommodation: 'Hotel Santa Lucia Cuenca 4★' },
      { day: 9, title: 'El Cajas National Park', description: 'Hike through Andean wetland páramo with trout lakes and birds.', meals: 'Breakfast & Lunch', accommodation: 'Hotel Santa Lucia Cuenca 4★' },
      { day: 10, title: 'Flight Return to Quito & Departure', description: 'Domestic flight Cuenca-Quito, connection to international airport.', meals: 'Breakfast' },
    ],
  },
  {
    ...
    exclusions: ['International flights', 'Gratuities', 'Personal expenses'],
    itinerary: [
      { day: 1, title: 'Quito Arrival', description: 'Airport pickup and colonial city orientation.', meals: 'None', accommodation: 'Hotel Boutique Quito 3★' },
      { day: 2, title: 'Quito Old Town & Equator', description: 'Historic centre + Mitad del Mundo monument.', meals: 'Breakfast', accommodation: 'Hotel Boutique Quito 3★' },
      { day: 3, title: 'Mindo Cloud Forest', description: 'Bird-watching, zip-line, butterfly garden, chocolate farm tour.', meals: 'Breakfast & Lunch', accommodation: 'Mindo Garden Lodge 3★' },
      { day: 4, title: 'Transfer to Amazon Tena Lodge', description: 'Drive from Quito through the Andes down to Tena lodge.', meals: 'Breakfast & Dinner', accommodation: 'Tena Eco-Lodge 3★' },
      { day: 5, title: 'Jungle Safari & Rescue Center', description: 'Canoe safari, visit animal rescue center and Quichua community.', meals: 'Breakfast, Lunch & Dinner', accommodation: 'Tena Eco-Lodge 3★' },
      { day: 6, title: 'Paikawe Lagoon Reserve', description: 'Guided walk inside the pristine jungle reserve spotting wildlife.', meals: 'Breakfast, Lunch & Dinner', accommodation: 'Tena Eco-Lodge 3★' },
      { day: 7, title: 'Return to Quito', description: 'Transfer back to Quito. Rest of day free.', meals: 'Breakfast', accommodation: 'Hotel Boutique Quito 3★' },
      { day: 8, title: 'Departure Transfer', description: 'Private transfer to Quito international airport.', meals: 'Breakfast' },
    ],
  },
  {
    ...
    itinerary: [
      { day: 1, title: 'Arrival Quito', description: 'Private airport transfer to luxury boutique hotel.', meals: 'None', accommodation: 'Casa Gangotena Quito 5★' },
      { day: 2, title: 'Colonial Quito & Equator', description: 'Private guided colonial tour + Mitad del Mundo monument.', meals: 'Breakfast', accommodation: 'Casa Gangotena Quito 5★' },
      { day: 3, title: 'Fly to Galapagos: San Cristobal', description: 'Flight to San Cristobal, La Loberia sea lion beach.', meals: 'Breakfast, Lunch & Dinner', accommodation: 'Casa Opuntia Galapagos 4★' },
      { day: 4, title: 'Kicker Rock Snorkel Expedition', description: 'Full-day yacht to Kicker Rock: Galapagos sharks & eagle rays.', meals: 'Breakfast & Onboard Lunch', accommodation: 'Casa Opuntia Galapagos 4★' },
      { day: 5, title: 'Santa Cruz: Tortoises & Las Grietas', description: 'Speedboat to Santa Cruz, highland tortoises, Las Grietas snorkel.', meals: 'Breakfast, Lunch & Dinner', accommodation: 'Finch Bay Eco Hotel 4★' },
      { day: 6, title: 'Galapagos: Santa Fe Island', description: 'Boat excursion to pristine Santa Fe Island snorkeling.', meals: 'Breakfast, Onboard Lunch & Dinner', accommodation: 'Finch Bay Eco Hotel 4★' },
      { day: 7, title: 'Tortuga Bay & Fly Back Quito', description: 'Morning at Tortuga Bay, afternoon flight to Quito.', meals: 'Breakfast', accommodation: 'Casa Gangotena Quito 5★' },
      { day: 8, title: 'Fly Quito to Cusco', description: 'Morning flight. Afternoon check-in to luxury Cusco hotel with coca tea welcome.', meals: 'Breakfast & Welcome Tea', accommodation: 'Palacio del Inka 5★' },
      { day: 9, title: 'Imperial Cusco: Qorikancha & Sacsayhuaman', description: 'Private guided tour of Cusco\'s Inca and colonial treasures.', meals: 'Breakfast', accommodation: 'Palacio del Inka 5★' },
      { day: 10, title: 'Sacred Valley & Ollantaytambo', description: 'Visit Pisac market, Maras salt pans, and Ollantaytambo fortress.', meals: 'Breakfast & Andean Buffet', accommodation: 'Tambo del Inka Resort 5★' },
      { day: 11, title: 'Vistadome Train & Machu Picchu', description: 'Panoramic train to Aguas Calientes. Afternoon VIP tour of Machu Picchu citadel.', meals: 'Breakfast & Lunch at Sanctuary Lodge', accommodation: 'Inkaterra Pueblo Hotel 5★' },
      { day: 12, title: 'Rainbow Mountain Trek', description: 'Spectacular high-altitude hike to Vinicunca Rainbow Mountain (5,020m).', meals: 'Breakfast & Box Lunch', accommodation: 'Palacio del Inka Cusco 5★' },
      { day: 13, title: 'Cusco Airport & Departure', description: 'Transfer to Alejandro Velasco Airport. Fly Lima connections.', meals: 'Breakfast' },
    ],
  },
  {
    ...
    itinerary: [
      { day: 1, title: 'Quito Arrival & Old Town', description: 'Airport pickup. Evening colonial city walk.', meals: 'None', accommodation: 'Hotel Quito 3★' },
      { day: 2, title: 'Quilotoa Crater Lake', description: 'Scenic drive and hike around the stunning emerald crater.', meals: 'Breakfast & Lunch', accommodation: 'Quilotoa Lodge' },
      { day: 3, title: 'Riobamba & Chimborazo', description: 'Explore the world\'s highest dormant volcano at Chimborazo.', meals: 'Breakfast & Lunch', accommodation: 'Hotel Riobamba 3★' },
      { day: 4, title: 'Baños & Pailon del Diablo', description: 'Full waterfall route day in Baños culminating at Devil\'s Cauldron.', meals: 'Breakfast', accommodation: 'Hotel Sangay Baños 3★' },
      { day: 5, title: 'Return Quito & Fly to Galapagos', description: 'Morning transfer and afternoon flight to San Cristobal Galapagos.', meals: 'Breakfast, Lunch & Dinner', accommodation: 'San Cristobal Hotel 3★' },
      { day: 6, title: 'Kicker Rock Snorkel Expedition', description: 'Open ocean boat excursion to León Dormido — sharks, rays, sea turtles.', meals: 'Breakfast & Onboard Lunch', accommodation: 'San Cristobal Hotel 3★' },
      { day: 7, title: 'Santa Cruz: Tortoises & Las Grietas', description: 'Speedboat to Santa Cruz. Highlands tortoises & volcanic Las Grietas crevice snorkel.', meals: 'Breakfast, Lunch & Dinner', accommodation: 'Solymar Hotel 3★' },
      { day: 8, title: 'Tortuga Bay & Las Ninfas', description: 'Hike to Tortuga Bay beach, afternoon Las Ninfas mangrove lagoon.', meals: 'Breakfast & Lunch', accommodation: 'Solymar Hotel 3★' },
      { day: 9, title: 'Isabela Island & Tintoreras', description: 'Speedboat to Isabela. Tintoreras penguin and iguana tour.', meals: 'Breakfast, Lunch & Dinner', accommodation: 'Albemarle Hotel 3★' },
      { day: 10, title: 'Sierra Negra Volcano Hike', description: 'Guided trek on the massive volcanic crater rim of Sierra Negra.', meals: 'Breakfast & Trail Lunch', accommodation: 'Albemarle Hotel 3★' },
      { day: 11, title: 'Transfer & Departure', description: 'Boat to Santa Cruz, bus to Baltra airport for outbound flight.', meals: 'Breakfast' },
    ],
  },
  {
    id: 'cusco-inca-trail',
    ...
    itinerary: [
      { day: 1, title: 'Cusco Arrival & Acclimatization', description: 'Luxury airport welcome and transfer. Afternoon rest with coca tea for altitude.', meals: 'Welcome Refreshments', accommodation: 'Palacio del Inka 5★' },
      { day: 2, title: 'Imperial Cusco City Tour', description: 'Private guided tour: Qorikancha Sun Temple, Sacsayhuaman fortress, Cusco Cathedral.', meals: 'Breakfast', accommodation: 'Palacio del Inka 5★' },
      { day: 3, title: 'Sacred Valley: Pisac & Ollantaytambo', description: 'Full-day Sacred Valley tour with highland market and Inca fortress.', meals: 'Breakfast & Andean Buffet Lunch', accommodation: 'Tambo del Inka Urubamba 5★' },
      { day: 4, title: 'Inca Trail Day 1: Km 82 to Wayllabamba', description: 'Trek start! Follow the Urubamba River through open plains and first Andean ruins.', meals: 'Breakfast, Lunch & Gourmet Dinner', accommodation: 'Luxury Trek Camp' },
      { day: 5, title: 'Inca Trail Day 2: Dead Woman\'s Pass (4,215m)', description: 'Hardest day — climb to Warmiwañusca, the highest pass on the trail, with panoramic views.', meals: 'Breakfast, Lunch & Dinner', accommodation: 'Luxury Trek Camp' },
      { day: 6, title: 'Inca Trail Day 3: Cloud Forest & Ruins', description: 'Trek through cloud forest, passing Phuyupatamarka ruins and Wiñaywayna terraces.', meals: 'Breakfast, Lunch & Farewell Camp Dinner', accommodation: 'Luxury Trek Camp' },
      { day: 7, title: 'Inca Trail Day 4: Sun Gate & Machu Picchu', description: 'Pre-dawn hike to the Sun Gate (Inti Punku) for sunrise at Machu Picchu. Private VIP citadel tour.', meals: 'Breakfast & Lunch at Machu Picchu', accommodation: 'Inkaterra Machu Picchu Pueblo Hotel 5★' },
      { day: 8, title: 'Machu Picchu Exploration Day', description: 'Optional: Hike Sun Mountain (Huayna Picchu) or return to citadel with free time. Afternoon Vistadome train to Cusco.', meals: 'Breakfast', accommodation: 'Palacio del Inka Cusco 5★' },
      { day: 9, title: 'Cusco Departure', description: 'Private transfer to Alejandro Velasco Airport for Lima connection.', meals: 'Breakfast' },
    ],
  },
];
